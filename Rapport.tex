...
\end{equation}
where m is the mass of the buoy, V its volume when the ballast is empty, and $\xi$ the place of the piston in the ballast (if $\xi = 0$ the ballast is empty). $\rho_w$ is the volumic mass of the water, and $g$ is the gravitation acceleration.
